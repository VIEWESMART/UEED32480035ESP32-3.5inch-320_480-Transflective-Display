...
/*select board*/
#define VIEWE_24_T      0  //2.4inch Display semi_transparent_up    change VIEWE_24_L35  D
#define VIEWE_28_T      0
#define VIEWE_35_T      1 //3.5inch semi_transparent_up   3.5半透半反   change VIEWE_H35  D  //VIEWE_H35 必须为1
